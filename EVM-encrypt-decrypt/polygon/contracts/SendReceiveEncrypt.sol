...
contract SendReceiveEncrypt is AxelarExecutable {
   ...
   Encrypt public storedEncrypt; // message received from _execute
    ...
    function _execute(
        ...
        ( bytes memory encrypted_data ) = abi.decode(payload, ( bytes));
        storedEncrypt = Encrypt(encrypted_data);
    }
}