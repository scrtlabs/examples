import * as CosmosBaseQueryV1beta1Pagination from "secretjs/src/grpc_gateway/cosmos/base/query/v1beta1/pagination.pb";
import * as CosmosBaseV1beta1Coin from "secretjs/src/grpc_gateway/cosmos/base/v1beta1/coin.pb";
import * as fm from "secretjs/src/grpc_gateway/fetch.pb";
import * as IbcCoreChannelV1Channel from "secretjs/src/grpc_gateway/ibc/core/channel/v1/channel.pb";
import * as IbcApplicationsFeeV1Fee from "secretjs/src/grpc_gateway/ibc/applications/fee/v1/fee.pb";
import * as IbcApplicationsFeeV1Genesis from "secretjs/src/grpc_gateway/ibc/applications/fee/v1/genesis.pb";
